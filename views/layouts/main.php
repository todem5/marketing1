...
<body class="d-flex flex-column h-100">
		...
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light bg-light my-navbar">
				<a class="navbar-brand" href="#"><img style="width: 90px;" src="img/sitelogo.png"></a>
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					...
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0 nav" id="main_menu">
						<li class="nav-item">
							<a class="nav-link messengers__link--wa" href="https://wa.me/+79236849170" target="_blank" title="WhatsApp">
