		...
		<div class="container">
			...
			echo Nav::widget([
				...
				'items' => [
					...
					['label' => 'Наши работы', 'url' => ['/site/index','#' => 'part6']],
					['label' => 'Цены', 'url' => ['/site/index','#' => 'part2']],
					['label' => 'Гарантии', 'url' => ['/site/index','#' => 'part4']],
					['label' => 'Вакансии', 'url' => ['/site/job'], 'visible' => false],
			...
			echo Nav::widget([
				...
				'items' => [
					'<li class="nav-item">
					<a class="nav-link messengers__link--wa" href="https://api.whatsapp/send?phone=79236849170&text=Добрый день! Я по поводу" target="_blank" title="WhatsApp">
					...
					'<li class="nav-item">
					<a class="nav-link messengers__link--tg" href="https://t.me/+79236849170" target="_blank" title="Telegram">
					...
					'<li class="nav-item">
					<a class="nav-link" href="tel:+7 923 684 9170" title="Позвонить">+7-923-684-9170</a>
					</li>',]
				]);
				NavBar::end();
				?>
